 ...
 * discovery item: AA/NZSA to supply real values). All the RFP-named groups are
 * present: PA, A, AS (ASA seeding), ASE, OB, P, AI, post-op.
 *
...
export const MODIFIER_CODES: readonly ModifierCode[] = [
  // Patient age (PA) — 1 to 4 units across the five bands
  { code: 'PA1', group: 'PA', units: 1, description: 'Patient age under 1 year' },
  { code: 'PA2', group: 'PA', units: 2, description: 'Patient age under 30 days' },
  { code: 'PA3', group: 'PA', units: 3, description: 'Patient age premature infant' },
  { code: 'PA4', group: 'PA', units: 4, description: 'Patient age extreme prematurity' },
  { code: 'PA5', group: 'PA', units: 1, description: 'Patient age over 70 years' },
  // After hours (A)
  { code: 'A1', group: 'A', units: 1, description: 'After hours, weekday evening' },
  { code: 'A2', group: 'A', units: 2, description: 'After hours, night / weekend / public holiday' },
  ...
  // Anaesthetist interaction (AI)
  { code: 'AI1', group: 'AI', units: 2, description: 'Assistance to another anaesthetist' },
  // Post-op
