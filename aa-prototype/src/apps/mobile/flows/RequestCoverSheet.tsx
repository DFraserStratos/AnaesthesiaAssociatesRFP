...
import { BottomSheet, MobileButton, TextArea, TickBadge } from '../components'
    ...
    <BottomSheet open={open} onClose={onClose}>
      {!sent ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <MobileButton variant="primary" block onClick={send}>
            Send cover request
          </MobileButton>
        </div>
      ) : (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12, padding: '12px 0 8px' }}>
          ...
          <MobileButton variant="secondary" block onClick={onClose} style={{ marginTop: 4 }}>
            Done
          </MobileButton>
        </div>
      )}
