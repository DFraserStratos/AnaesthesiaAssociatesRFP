...
/**
 * The mobile button set (convention 16; ≥44px targets, N1). Teal is the only
 * action colour (`accent.base`); secondary is the design's outlined control;
 * pill is the compact tinted action used on rows and chips. Mobile-local — the
 * web app abstracts its own set in Phase 05, so this is deliberately not shared.
 */
